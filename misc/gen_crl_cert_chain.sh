...
# Create intermediary CA 1 certificate with CRL URL
...
crlDistributionPoints=URI:http://10.10.10.10:9819
EOF
)
...
# Create intermediary CA 2 certificate with CRL URL
...
# Create server.ext file for SANs and CRL URL
...
# Sign server CSR with intermediary CA 2 and include CRL URL
...
echo "Root CA, two intermediary CAs, and server key pair generated successfully, with CRL distribution points included."
